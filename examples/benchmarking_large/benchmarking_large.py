...
#           RandomForestClassifier(n_estimators=500, max_features=0.25, criterion='entropy', random_state=2001),
#           MLPClassifier(max_iter=200, n_iter_no_change=2, tol=1e-3, random_state=2001),
#           CatBoostClassifier(iterations=500, max_depth=3)
]
...
category_encoders.MEstimateEncoder(handle_missing='indicator'),
             category_encoders.OneHotEncoder(handle_missing='value'),
category_encoders.OneHotEncoder(handle_missing='indicator'),
             category_encoders.OrdinalEncoder(handle_missing='value'),
category_encoders.OrdinalEncoder(handle_missing='indicator'),
             # category_encoders.PolynomialEncoder(),
             # category_encoders.SumEncoder(),
             category_encoders.TargetEncoder(handle_missing='value'),
category_encoders.TargetEncoder(handle_missing='indicator'),
             category_encoders.WOEEncoder(handle_missing='value'),
category_encoders.WOEEncoder(handle_missing='indicator')]
